...
CampzimmerResource.prototype._defaultHeaders = function(auth, contentLength, apiVersion) {
...
CampzimmerResource.prototype._request = function(method, host, path, data, auth, options, callback) {
    let requestData;
